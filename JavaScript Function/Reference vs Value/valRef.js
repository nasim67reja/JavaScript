...
function memberInformation(acntnum, inform) {
  ...
  return `Hello Mr. ${inform.Name},Your Last deposite was ${inform.lastDepostie} in
 ${inform.lastDepostieDate} 
and Your total ammount is ${inform.totalAmount}`;
}
console.log(memberInformation(accountNum, inform12312340));
// console.log(inform12312340); // note it is also affected . details in jonas course.
